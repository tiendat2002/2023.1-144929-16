...
import com.example.timekeeping.Models.Client;
...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        position.setText(this.client.positionProperty().getValue());
        salary.setText(this.client.salaryProperty().getValue());
        manager.setText(this.client.managerProperty().getValue());
        department.setText(this.client.departmentProperty().getValue());
        room.setText(this.client.roomProperty().getValue());
        name.setText("Hi, " + this.client.nameProperty().getValue());
        date.setText(LocalDate.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
        addDayOfWeek();
        handelScheduleInThisWeek(Model.getInstance().getDatabaseDriver().getHistoryClientThisWeek(client.idProperty().getValue()));
        handelChart(Model.getInstance().getDatabaseDriver().getHistoryClientThisMonth(client.idProperty().getValue()));
    ...
    public void handelChart(ResultSet clientScheduleThisMonth){
        ...
        Map<Integer,Integer> dayoffMap = handelScheduleToDayOff(clientScheduleThisMonth);
